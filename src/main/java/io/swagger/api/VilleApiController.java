...
public class VilleApiController implements VilleApi {
    ...
    public VilleApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<Void> addVille(@ApiParam(value = "ville à ajouter"  )  @Valid @RequestBody Ville ville) {
